...
AQL-driven CLI and REPL for the JellyBellyWiki SDK. Positional arguments are
...
```sh
go build -o jelly-belly-wiki-cli ./...
```
...
./jelly-belly-wiki-cli load 1 bean
./jelly-belly-wiki-cli load '{id:1}' bean
