...
func registerSDKWords(r *eng.Registry, client *sdk.JellyBellyWikiSDK) {
...
func runOp(client *sdk.JellyBellyWikiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
