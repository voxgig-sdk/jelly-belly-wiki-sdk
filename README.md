...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jelly-belly-wiki` | `npm install @voxgig-sdk/jelly-belly-wiki` |
| Python | `voxgig-sdk-jelly-belly-wiki` | `pip install voxgig-sdk-jelly-belly-wiki` |
| PHP | `voxgig-sdk/jelly-belly-wiki` | `composer require voxgig-sdk/jelly-belly-wiki` |
| Golang | `github.com/voxgig-sdk/jelly-belly-wiki-sdk/go` | `go get github.com/voxgig-sdk/jelly-belly-wiki-sdk/go` |
| Ruby | `voxgig-sdk-jelly-belly-wiki` | `gem install voxgig-sdk-jelly-belly-wiki` |
| Lua | `voxgig-sdk-jelly-belly-wiki` | `luarocks install voxgig-sdk-jelly-belly-wiki` |
