...
from jellybellywiki_sdk.utility import register

# Load features
from jellybellywiki_sdk.feature.base_feature import JellyBellyWikiBaseFeature
from jellybellywiki_sdk.features import _has_feature, _make_feature
...
class JellyBellyWikiSDK:
    ...
    def get_utility(self):
        return JellyBellyWikiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JellyBellyWikiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Bean(self, data=None) -> "BeanEntity":
        ...
        from jellybellywiki_sdk.entity.bean_entity import BeanEntity
    ...
    def Combination(self, data=None) -> "CombinationEntity":
        ...
        from jellybellywiki_sdk.entity.combination_entity import CombinationEntity
        return CombinationEntity(self, data)


    def Fact(self, data=None) -> "FactEntity":
        """Entity factory: client.Fact().list() / client.Fact().load({"id": ...})."""
        from jellybellywiki_sdk.entity.fact_entity import FactEntity
    ...
    def History(self, data=None) -> "HistoryEntity":
        ...
        from jellybellywiki_sdk.entity.history_entity import HistoryEntity
    ...
    def Recipe(self, data=None) -> "RecipeEntity":
        ...
        from jellybellywiki_sdk.entity.recipe_entity import RecipeEntity
