# JellyBellyWiki SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JellyBellyWikiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JellyBellyWikiSDK(...) and JellyBellyWikiSDK.test(...) become
#      JellyBellyWikiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jellybellywiki_sdk"
_SDK_CLASS = "JellyBellyWikiSDK"
