...
class JellyBellyWikiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JellyBellyWikiTestRunner.getenv("JELLYBELLYWIKI_TEST_LIVE")
        override = JellyBellyWikiTestRunner.getenv("JELLYBELLYWIKI_TEST_OVERRIDE")
        ...
        explain = JellyBellyWikiTestRunner.getenv("JELLYBELLYWIKI_TEST_EXPLAIN")
