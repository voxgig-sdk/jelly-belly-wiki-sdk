...
class CombinationEntity extends JellyBellyWikiEntityBase_1.JellyBellyWikiEntityBase {
    constructor(client, entopts) {
        ...
        this.name_ = 'combination';
        this.Name = 'Combination';
    }
    make() {
        return new CombinationEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Combination[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CombinationEntity = CombinationEntity;
//# sourceMappingURL=CombinationEntity.js.map