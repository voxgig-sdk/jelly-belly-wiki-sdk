...
(0, node_test_1.describe)('FactDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-fact', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-fact', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JELLY_BELLY_WIKI_TEST_FACT_ENTID'];
...
//# sourceMappingURL=FactDirect.test.js.map