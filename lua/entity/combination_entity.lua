...
local CombinationEntity = {}
CombinationEntity.__index = CombinationEntity


function CombinationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CombinationEntity)
  self._name = "combination"
  self._client = client
...
function CombinationEntity:get_name()
  return self._name
end


function CombinationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CombinationEntity.new(self._client, opts)
end
...
function CombinationEntity:mark_deleted()
  self._deleted = true
end


function CombinationEntity:deleted()
  return true == self._deleted
end


function CombinationEntity:data_set(args)
  if args ~= nil then
...
function CombinationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CombinationEntity:match_set(args)
  if args ~= nil then
...
function CombinationEntity:match_get()
...
function CombinationEntity:stream(action, args, callopts)
...
function CombinationEntity:_run_op(ctx, post_done)
  local utility = self._utility
