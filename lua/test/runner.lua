...
function runner.env_override(m)
  local live = runner.getenv("JELLYBELLYWIKI_TEST_LIVE")
  local override = runner.getenv("JELLYBELLYWIKI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JELLYBELLYWIKI_TEST_EXPLAIN")
