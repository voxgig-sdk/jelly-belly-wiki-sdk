...
function runner.env_override(m)
  local live = runner.getenv("JELLY_BELLY_WIKI_TEST_LIVE")
  local override = runner.getenv("JELLY_BELLY_WIKI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JELLY_BELLY_WIKI_TEST_EXPLAIN")
