...
describe("CombinationDirect", function()
  it("should direct-list-combination", function()
    local setup = combination_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-combination", setup.live and "live" or "unit")
...
function combination_direct_setup(mockres)
