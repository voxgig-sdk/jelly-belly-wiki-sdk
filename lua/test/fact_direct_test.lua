...
describe("FactDirect", function()
  it("should direct-list-fact", function()
    local setup = fact_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-fact", setup.live and "live" or "unit")
...
function fact_direct_setup(mockres)
