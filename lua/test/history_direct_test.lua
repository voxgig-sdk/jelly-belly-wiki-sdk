...
describe("HistoryDirect", function()
  it("should direct-list-history", function()
    local setup = history_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-history", setup.live and "live" or "unit")
...
function history_direct_setup(mockres)
