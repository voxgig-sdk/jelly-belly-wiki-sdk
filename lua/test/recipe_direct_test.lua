...
describe("RecipeDirect", function()
  it("should direct-list-recipe", function()
    local setup = recipe_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-recipe", setup.live and "live" or "unit")
...
function recipe_direct_setup(mockres)
