...
local SDK_MODULE = "jelly-belly-wiki_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["bean"] = { ["test01"] = { id = "test01" } }, ["combination"] = { ["test01"] = { id = "test01" } }, ["fact"] = { ["test01"] = { id = "test01" } }, ["history"] = { ["test01"] = { id = "test01" } }, ["recipe"] = { ["test01"] = { id = "test01" } } } }'
