...
// JellyBellyWiki SDK netsim feature
...
class JellyBellyWikiNetsimFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _simulate(JellyBellyWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JellyBellyWikiContext $ctx, array $applied): void
    {
        $client = $this->client;
