...
// JellyBellyWiki SDK clienttrack feature
...
class JellyBellyWikiClienttrackFeature extends JellyBellyWikiBaseFeature
{
    ...
    public function PostConstruct(JellyBellyWikiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JellyBellyWiki-SDK';
