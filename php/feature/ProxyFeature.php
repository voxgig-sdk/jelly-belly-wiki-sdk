...
// JellyBellyWiki SDK proxy feature
...
class JellyBellyWikiProxyFeature extends JellyBellyWikiBaseFeature
{
    ...
    public function init(JellyBellyWikiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JellyBellyWikiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
