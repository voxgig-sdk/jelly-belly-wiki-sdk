...
// JellyBellyWiki SDK metrics feature
...
class JellyBellyWikiMetricsFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _record(JellyBellyWikiContext $ctx, bool $ok): void
    {
