...
// JellyBellyWiki SDK audit feature
...
class JellyBellyWikiAuditFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _emit(JellyBellyWikiContext $ctx, string $outcome): void
    {
