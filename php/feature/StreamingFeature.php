...
// JellyBellyWiki SDK streaming feature
...
class JellyBellyWikiStreamingFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _iterate(JellyBellyWikiResult $result): \Generator
    {
    ...
    private function _streamable(JellyBellyWikiContext $ctx): bool
    {
