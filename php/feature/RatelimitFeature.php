...
// JellyBellyWiki SDK ratelimit feature
...
class JellyBellyWikiRatelimitFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _acquire(JellyBellyWikiContext $ctx): void
    {
    ...
    private function _track(JellyBellyWikiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
