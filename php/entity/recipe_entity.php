...
// JellyBellyWiki SDK Recipe entity
...
class RecipeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RecipeEntity($this->_client, $opts);
    }

    /**
     * @param Recipe|array $args Recipe data (assoc-array) to store.
     */
    ...
    /**
     * @return Recipe|array The current Recipe data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Recipe fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Recipe fields).
     */
    ...
    /**
     * List Recipe items matching the given filter.
     *
     * @param RecipeListMatch|array|null $reqmatch Match filter (any subset
     *   of Recipe fields) as an assoc-array; RecipeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Recipe[]|array A list of Recipe items as assoc-arrays at
