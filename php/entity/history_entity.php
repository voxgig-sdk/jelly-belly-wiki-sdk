...
// JellyBellyWiki SDK History entity
...
class HistoryEntity
{
     ...
     *
     * @param HistoryListMatch|array|null $reqmatch Match filter (any subset
     *   of History fields) as an assoc-array; HistoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return History[]|array A list of History items as assoc-arrays at
