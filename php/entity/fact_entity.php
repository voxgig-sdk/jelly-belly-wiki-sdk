...
// JellyBellyWiki SDK Fact entity
...
class FactEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FactEntity($this->_client, $opts);
    }

    /**
     * @param Fact|array $args Fact data (assoc-array) to store.
     */
    ...
    /**
     * @return Fact|array The current Fact data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Fact fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Fact fields).
     */
    ...
    /**
     * List Fact items matching the given filter.
     *
     * @param FactListMatch|array|null $reqmatch Match filter (any subset
     *   of Fact fields) as an assoc-array; FactListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Fact[]|array A list of Fact items as assoc-arrays at
