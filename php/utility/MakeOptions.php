...
// JellyBellyWiki SDK utility: make_options

class JellyBellyWikiMakeOptions
{
    ...
    public static function call(JellyBellyWikiContext $ctx): array
    {
        ...
        //
        // `JellyBellyWikiSchema::optspec()` is built from the model:
        ...
        $optspec = JellyBellyWikiSchema::optspec();
