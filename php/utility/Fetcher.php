...
// JellyBellyWiki SDK utility: fetcher

class JellyBellyWikiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JellyBellyWikiSDK/1.0)';
    ...
    public static function call(JellyBellyWikiContext $ctx, string $fullurl, array $fetchdef): array
    {
