...
// JellyBellyWiki SDK utility: graphql
//
...
class JellyBellyWikiGraphql
{
    ...
    // equivalent.
    public static function body(JellyBellyWikiContext $ctx): mixed
    {
    ...
    public static function errors(JellyBellyWikiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
