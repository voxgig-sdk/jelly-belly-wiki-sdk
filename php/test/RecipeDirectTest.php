...
class RecipeDirectTest extends TestCase
{
    public function test_direct_list_recipe(): void
    {
        $setup = recipe_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-recipe", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
