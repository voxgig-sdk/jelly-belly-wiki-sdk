...
// JellyBellyWiki SDK pipeline test
//
...
{
    private static function utility(): JellyBellyWikiUtility
    {
        return new JellyBellyWikiUtility();
    }
    ...
    private static function ctx(array $over = []): JellyBellyWikiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new JellyBellyWikiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new JellyBellyWikiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof JellyBellyWikiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new JellyBellyWikiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = JellyBellyWikiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new JellyBellyWikiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = JellyBellyWikiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new JellyBellyWikiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = JellyBellyWikiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JellyBellyWikiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = JellyBellyWikiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new JellyBellyWikiResponse([]),
            'result' => new JellyBellyWikiResult([]),
        ]);
        [, $err] = JellyBellyWikiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec([]),
            'response' => null,
            'result' => new JellyBellyWikiResult([]),
        ]);
        [, $err] = JellyBellyWikiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec(['step' => 's']),
            'response' => new JellyBellyWikiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new JellyBellyWikiResult([]),
        ]);
        [, $err] = JellyBellyWikiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec(['step' => 's']),
            'response' => new JellyBellyWikiResponse(self::resp(200, ['v' => 1])),
            'result' => new JellyBellyWikiResult([]),
        ]);
        [, $err] = JellyBellyWikiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec(['step' => 's']),
            'response' => new JellyBellyWikiResponse(self::resp(200, ['v' => 2])),
            'result' => new JellyBellyWikiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        JellyBellyWikiMakeResponse::call($ctx);
    ...
    {
        $preset = new JellyBellyWikiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec([]),
            'response' => new JellyBellyWikiResponse([]),
            'result' => new JellyBellyWikiResult([]),
        ...
        [$got, $err] = JellyBellyWikiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new JellyBellyWikiResult([])]);
        [, $err] = JellyBellyWikiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new JellyBellyWikiSpec([]), 'result' => null]);
        [, $err] = JellyBellyWikiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JellyBellyWikiSpec(['step' => 's']),
            'result' => new JellyBellyWikiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new JellyBellyWikiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JellyBellyWikiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JellyBellyWikiSpec(['step' => 's']),
            'result' => new JellyBellyWikiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new JellyBellyWikiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JellyBellyWikiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JellyBellyWikiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new JellyBellyWikiSpec([]),
            'result' => new JellyBellyWikiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = JellyBellyWikiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JellyBellyWikiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new JellyBellyWikiError('boom', 'boom');
        $utility->fetcher = function (JellyBellyWikiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JellyBellyWikiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = JellyBellyWikiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (JellyBellyWikiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = JellyBellyWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(JellyBellyWikiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        JellyBellyWikiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (JellyBellyWikiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JellyBellyWikiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = JellyBellyWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new JellyBellyWikiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new JellyBellyWikiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = JellyBellyWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = JellyBellyWikiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = JellyBellyWikiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new JellyBellyWikiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, JellyBellyWikiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new JellyBellyWikiResult(['ok' => false])]);
        $this->expectException(JellyBellyWikiError::class);
        JellyBellyWikiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new JellyBellyWikiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', JellyBellyWikiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        JellyBellyWikiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new JellyBellyWikiBaseFeature();
        $b = new JellyBellyWikiBaseFeature();
        JellyBellyWikiFeatureAdd::call($ctx, $a);
        JellyBellyWikiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): JellyBellyWikiBaseFeature
    {
        $f = new JellyBellyWikiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        JellyBellyWikiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): JellyBellyWikiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new JellyBellyWikiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JellyBellyWikiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        JellyBellyWikiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new JellyBellyWikiResponse(['headers' => null]),
            'result' => new JellyBellyWikiResult([]),
        ]);
        JellyBellyWikiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        JellyBellyWikiResultBody::call($ctx);
