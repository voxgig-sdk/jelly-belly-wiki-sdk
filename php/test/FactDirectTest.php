...
class FactDirectTest extends TestCase
{
    public function test_direct_list_fact(): void
    {
        $setup = fact_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-fact", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
