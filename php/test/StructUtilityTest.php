...
// JellyBellyWiki SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JellyBellyWikiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JellyBellyWikiOmni::structfix($now, Struct::undef()))
                        !== json_encode(JellyBellyWikiOmni::structfix($val, Struct::undef()))) {
