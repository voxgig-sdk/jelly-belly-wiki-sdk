...
// JellyBellyWiki SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JellyBellyWikiSDK::test)
...
{
    private const SDK_CLASS = 'JellyBellyWikiSDK';
    ...
    private const SDK_BASE = 'jellybellywiki_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jellybellywiki_sdk.php';
