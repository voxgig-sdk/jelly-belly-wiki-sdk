...
class HistoryDirectTest extends TestCase
{
    public function test_direct_list_history(): void
    {
        $setup = history_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-history", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
