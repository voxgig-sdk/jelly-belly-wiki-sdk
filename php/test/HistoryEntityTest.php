...
class HistoryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set JELLYBELLYWIKI_TEST_HISTORY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function history_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("JELLYBELLYWIKI_TEST_HISTORY_ENTID");
