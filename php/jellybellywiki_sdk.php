...
class JellyBellyWikiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = JellyBellyWikiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = JellyBellyWikiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!JellyBellyWikiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, JellyBellyWikiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return JellyBellyWikiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = JellyBellyWikiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = JellyBellyWikiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = JellyBellyWikiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new JellyBellyWikiError($op . "_allow",
                "JellyBellyWikiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = JellyBellyWikiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new JellyBellyWikiError("graphql_error",
                "JellyBellyWikiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Bean($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_bean === null) {
                $this->_bean = new BeanEntity($this, null);
            }
            return $this->_bean;
        }
        return new BeanEntity($this, $data);
    }
    ...
    public function Combination($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_combination === null) {
                $this->_combination = new CombinationEntity($this, null);
            }
            return $this->_combination;
        }
        return new CombinationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new JellyBellyWikiSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
