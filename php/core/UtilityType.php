...
// JellyBellyWiki SDK utility type

class JellyBellyWikiUtility
{
    ...
    public static function copy(JellyBellyWikiUtility $src): JellyBellyWikiUtility
    {
        $u = new JellyBellyWikiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
