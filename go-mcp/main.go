// Command JellyBellyWiki-mcp is an MCP server exposing the JellyBellyWiki
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JellyBellyWiki_list  — list records of an entity
//	JellyBellyWiki_load  — load a single record of an entity
//
