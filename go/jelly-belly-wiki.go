...
import (
	...
	"github.com/voxgig-sdk/jelly-belly-wiki-sdk/go/entity"
	"github.com/voxgig-sdk/jelly-belly-wiki-sdk/go/feature"
	_ "github.com/voxgig-sdk/jelly-belly-wiki-sdk/go/utility"
)
...
// instead of `sdk.NewJellyBellyWikiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *JellyBellyWikiSDK  { return NewJellyBellyWikiSDK(nil) }
func Test() *JellyBellyWikiSDK { return TestSDK(nil, nil) }
