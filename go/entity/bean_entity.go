...
func NewBeanEntity(client *core.JellyBellyWikiSDK, entopts map[string]any) *BeanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BeanEntity) GetName() string { return e.name }
...
func (e *BeanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BeanEntity) Deleted() bool {
	return e.deleted
}


func (e *BeanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBeanEntity(e.client, opts)
}

func (e *BeanEntity) Data(args ...any) any {
...
func (e *BeanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bean; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BeanEntity) DataTyped(data ...Bean) Bean {
	if len(data) > 0 {
		return typedFrom[Bean](e.Data(asMap(data[0])))
	}
	return typedFrom[Bean](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bean (all fields
// optional at the wire level).
func (e *BeanEntity) MatchTyped(match ...Bean) Bean {
	if len(match) > 0 {
		return typedFrom[Bean](e.Match(asMap(match[0])))
	}
	return typedFrom[Bean](e.Match())
}
...
func (e *BeanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BeanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BeanLoadMatch and returns an Bean. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BeanEntity) LoadTyped(reqmatch BeanLoadMatch, ctrl map[string]any) (Bean, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Bean{}, err
	}
	return typedFrom[Bean](res), nil
}




func (e *BeanEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BeanListMatch and returns []Bean. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BeanEntity) ListTyped(reqmatch BeanListMatch, ctrl map[string]any) ([]Bean, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Bean](res), nil
}



func (e *BeanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BeanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BeanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BeanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
