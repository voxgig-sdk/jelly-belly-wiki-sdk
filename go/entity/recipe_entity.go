...
func NewRecipeEntity(client *core.JellyBellyWikiSDK, entopts map[string]any) *RecipeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecipeEntity) GetName() string { return e.name }
...
func (e *RecipeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecipeEntity) Deleted() bool {
	return e.deleted
}


func (e *RecipeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecipeEntity(e.client, opts)
}

func (e *RecipeEntity) Data(args ...any) any {
...
func (e *RecipeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Recipe; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecipeEntity) DataTyped(data ...Recipe) Recipe {
	if len(data) > 0 {
		return typedFrom[Recipe](e.Data(asMap(data[0])))
	}
	return typedFrom[Recipe](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Recipe (all fields
// optional at the wire level).
func (e *RecipeEntity) MatchTyped(match ...Recipe) Recipe {
	if len(match) > 0 {
		return typedFrom[Recipe](e.Match(asMap(match[0])))
	}
	return typedFrom[Recipe](e.Match())
}
...
func (e *RecipeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecipeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RecipeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecipeListMatch and returns []Recipe. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RecipeEntity) ListTyped(reqmatch RecipeListMatch, ctrl map[string]any) ([]Recipe, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Recipe](res), nil
}



func (e *RecipeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecipeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecipeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecipeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
