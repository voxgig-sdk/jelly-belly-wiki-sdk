...
func NewFactEntity(client *core.JellyBellyWikiSDK, entopts map[string]any) *FactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FactEntity) GetName() string { return e.name }
...
func (e *FactEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FactEntity) Deleted() bool {
	return e.deleted
}


func (e *FactEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFactEntity(e.client, opts)
}

func (e *FactEntity) Data(args ...any) any {
...
func (e *FactEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Fact; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FactEntity) DataTyped(data ...Fact) Fact {
	if len(data) > 0 {
		return typedFrom[Fact](e.Data(asMap(data[0])))
	}
	return typedFrom[Fact](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Fact (all fields
// optional at the wire level).
func (e *FactEntity) MatchTyped(match ...Fact) Fact {
	if len(match) > 0 {
		return typedFrom[Fact](e.Match(asMap(match[0])))
	}
	return typedFrom[Fact](e.Match())
}
...
func (e *FactEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FactEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FactEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FactListMatch and returns []Fact. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FactEntity) ListTyped(reqmatch FactListMatch, ctrl map[string]any) ([]Fact, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Fact](res), nil
}



func (e *FactEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FactEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FactEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FactEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
