...
type CombinationEntity struct {
	name    string
	client  *core.JellyBellyWikiSDK
...
func NewCombinationEntity(client *core.JellyBellyWikiSDK, entopts map[string]any) *CombinationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CombinationEntity) GetName() string { return e.name }
...
func (e *CombinationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CombinationEntity) Deleted() bool {
	return e.deleted
}


func (e *CombinationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCombinationEntity(e.client, opts)
}

func (e *CombinationEntity) Data(args ...any) any {
...
func (e *CombinationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Combination; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CombinationEntity) DataTyped(data ...Combination) Combination {
	if len(data) > 0 {
		return typedFrom[Combination](e.Data(asMap(data[0])))
	}
	return typedFrom[Combination](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Combination (all fields
// optional at the wire level).
func (e *CombinationEntity) MatchTyped(match ...Combination) Combination {
	if len(match) > 0 {
		return typedFrom[Combination](e.Match(asMap(match[0])))
	}
	return typedFrom[Combination](e.Match())
}
...
func (e *CombinationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CombinationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CombinationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CombinationListMatch and returns []Combination. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CombinationEntity) ListTyped(reqmatch CombinationListMatch, ctrl map[string]any) ([]Combination, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Combination](res), nil
}



func (e *CombinationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CombinationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CombinationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CombinationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
