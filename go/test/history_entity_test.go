...
func TestHistoryEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set JELLYBELLYWIKI_TEST_HISTORY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func historyBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("JELLYBELLYWIKI_TEST_HISTORY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["JELLYBELLYWIKI_TEST_HISTORY_ENTID"])
