...
const testSeed = `map[string]any{"entity": map[string]any{"bean": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "combination": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recipe": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
