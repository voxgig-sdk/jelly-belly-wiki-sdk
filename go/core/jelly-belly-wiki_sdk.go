...
func (sdk *JellyBellyWikiSDK) OptionsMap() map[string]any {
...
func (sdk *JellyBellyWikiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JellyBellyWikiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JellyBellyWikiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JellyBellyWikiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JellyBellyWikiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JellyBellyWikiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JellyBellyWikiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JellyBellyWikiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JellyBellyWikiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JellyBellyWikiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *JellyBellyWikiSDK {
	...
	sdk := NewJellyBellyWikiSDK(sdkopts)
	sdk.Mode = "test"
