...
The Golang SDK for the JellyBellyWiki API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/jelly-belly-wiki-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/jelly-belly-wiki-sdk=../path/to/github.com/voxgig-sdk/jelly-belly-wiki-sdk
```
...
```
github.com/voxgig-sdk/jelly-belly-wiki-sdk/
...
The root package (`github.com/voxgig-sdk/jelly-belly-wiki-sdk`) re-exports everything needed
