...
class BeanEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set JELLY_BELLY_WIKI_TEST_BEAN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def bean_basic_setup(extra)
  ...
  entid_env_raw = ENV["JELLY_BELLY_WIKI_TEST_BEAN_ENTID"]
