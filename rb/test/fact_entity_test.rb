...
class FactEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set JELLYBELLYWIKI_TEST_FACT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def fact_basic_setup(extra)
  ...
  entid_env_raw = ENV["JELLYBELLYWIKI_TEST_FACT_ENTID"]
