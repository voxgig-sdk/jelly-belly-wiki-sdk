...
#      offline in seeded test mode (JellyBellyWikiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "JellyBellyWiki_sdk.rb")
  SDK_CLASS = "JellyBellyWikiSDK"
