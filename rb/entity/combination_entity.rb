...
class CombinationEntity
  ...
  def make
    opts = @_entopts.dup
    CombinationEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CombinationListMatch, Hash, nil] match filter (any subset of
  #   Combination fields); defaults to nil, treated as an empty match that lists all.
