...
class RecipeEntity
  ...
  # @return [Recipe, Hash] the current Recipe data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Recipe fields)
  def match_get
  ...
  #
  # @param reqmatch [RecipeListMatch, Hash, nil] match filter (any subset of
  #   Recipe fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Recipe>, Array] the matching Recipe items; raises JellyBellyWikiError on failure
