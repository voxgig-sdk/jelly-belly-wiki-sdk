...
class FactEntity
  ...
  # @return [Fact, Hash] the current Fact data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Fact fields)
  def match_get
  ...
  #
  # @param reqmatch [FactListMatch, Hash, nil] match filter (any subset of
  #   Fact fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Fact>, Array] the matching Fact items; raises JellyBellyWikiError on failure
