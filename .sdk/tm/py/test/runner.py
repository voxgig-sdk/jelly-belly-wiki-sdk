...
class JellyBellyWikiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JellyBellyWikiTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = JellyBellyWikiTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = JellyBellyWikiTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
