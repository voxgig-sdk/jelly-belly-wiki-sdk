...
class JellyBellyWikiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JellyBellyWikiTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = JellyBellyWikiTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = JellyBellyWikiTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
