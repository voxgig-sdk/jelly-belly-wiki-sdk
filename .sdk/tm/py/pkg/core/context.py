...
from projectname_sdk.core.control import JellyBellyWikiControl
...
class JellyBellyWikiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = JellyBellyWikiControl()
        ...
        if isinstance(sp, JellyBellyWikiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JellyBellyWikiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JellyBellyWikiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return JellyBellyWikiOperation({})
    ...
    def make_error(self, code, msg):
        return JellyBellyWikiError(code, msg, self)
