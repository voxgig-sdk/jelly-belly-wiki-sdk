...
// JellyBellyWiki SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class JellyBellyWikiMakeRequest
{
    public static function call(JellyBellyWikiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new JellyBellyWikiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new JellyBellyWikiResponse($fetched);
        } else {
