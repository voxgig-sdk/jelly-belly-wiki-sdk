...
// JellyBellyWiki SDK timeout feature
...
class JellyBellyWikiTimeoutFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _with_timeout(JellyBellyWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JellyBellyWikiContext $_ctx, float $ms): void
    {
        $client = $this->client;
