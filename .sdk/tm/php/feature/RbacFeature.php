...
// JellyBellyWiki SDK rbac feature
...
class JellyBellyWikiRbacFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _required(JellyBellyWikiContext $ctx): ?string
    {
    ...
    private function _reject(JellyBellyWikiContext $ctx, string $required): void
    {
    ...
    private function _track(JellyBellyWikiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
