...
// JellyBellyWiki SDK cache feature
...
class JellyBellyWikiCacheFeature extends JellyBellyWikiBaseFeature
{
    ...
    private function _through(JellyBellyWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
