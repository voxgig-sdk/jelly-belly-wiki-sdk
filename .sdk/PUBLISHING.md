...
|---|---|---|
| `ts/` | @voxgig-sdk/jelly-belly-wiki-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jelly-belly-wiki-sdk \
      --repository voxgig-sdk/jelly-belly-wiki-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jelly-belly-wiki-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jelly-belly-wiki-sdk --id=<id>` removes it.
